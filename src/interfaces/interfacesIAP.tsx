import {PayloadResponseEditDetailsUser} from './interfacesApp';
...
export interface ResDetailsOneMemberOfBackend {
  error: boolean;
  statusCode: number;
  payload: PayloadResDetailsOneMemberOfBackend;
  message: string;
}

export interface PayloadResDetailsOneMemberOfBackend {
  id: number;
  name: string;
  lastname: string;
  address: null;
