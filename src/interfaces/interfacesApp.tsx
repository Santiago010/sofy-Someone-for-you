...
export interface ResMyInterectionsWithOthers {
  error: boolean;
  statusCode: number;
  payload: PayloadResMyInteractionsWithOthers[];
  message: string;
}

export interface PayloadResMyInteractionsWithOthers {
  id: number;
  toIndividual: ToIndividual;
  isLike: boolean;
  isVisible: boolean;
...
export interface ResInteractionsWithMe {
  error: boolean;
  statusCode: number;
  payload: PayloadResInteractionsWithMe[];
  message: string;
}

export interface PayloadResInteractionsWithMe {
  id: number;
  fromIndividual: FromIndividual;
  isLike: boolean;
  isVisible: boolean;
